...
public class ChatGPTConnection
{
	...
	public ChatGPTConnection(string apiKey)
	{
		...
		_messageList.Add(
			...
			"###指示###"+
			"あなたはゲームマスターです。物語を展開してください。"+
			"私は物語の主人公のキャラクターです。"+
			"###ゲーム仕様###"+
			"あなた：ゲームマスターとして魅力的な体験を提供します。主人公が見る景色、主人公以外のキャラクターのセリフを説明してください。主人公の次の行動の選択肢を説明してください。"+
			"私：チャットで行動を入力します。"+
			"###条件###"+"登場人物は２人です。"+"物語の舞台は学校です。"+"コードブロックの中ではゲームの出力のみを行てください。"+
			//"###形式###"+"セリフは、"+"発言者の名前：セリフ"+"セリフ以外の説明は、"+"説明"
			"物語のタイトルは「"+TitleSingleton.Instance.title+"」です。"
			});
